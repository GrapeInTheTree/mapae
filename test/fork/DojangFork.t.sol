...
contract DojangForkTest is Test {
    ...
    function test_AttesterIdDerivation() public pure {
        assertEq(
    ...
    function test_UpbitVerifiedEoa_Passes() public view {
        assertTrue(
    ...
    function test_UpbitVerifiedEoa_FailsUnderFaucetId() public view {
        assertFalse(
    ...
    function test_UnattestedAddress_IsNotVerified() public view {
